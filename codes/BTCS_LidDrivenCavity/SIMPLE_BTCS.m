...
dt_accel = 1e-6;                        % a number between [0,1], 1 corresponds to the FTCS time step, 0 to fully BTCS
...
%     end
    ...
    % STEP #3 Implicit:
    [ustar,erru,ku] = CGsolver(rhsustar,@MatVecProd_u);
    [vstar,errv,kv] = CGsolver(rhsvstar,@MatVecProd_v);
