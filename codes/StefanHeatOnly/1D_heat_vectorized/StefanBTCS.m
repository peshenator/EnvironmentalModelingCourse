...
%%  Newsted Newton method of Casulli & Zanolli
    ...
    for iouter = 1:MaxNewton
        ResOut = ResidualOuter(T0,a,b,c,rhs);    % Compute the residual of the outer iterations
...
%         disp(strcat('Outer iteration = ',num2str(iouter),'|| residual =',num2str(ResOut_norm)))
        ...
        for iinner = 1:MaxNewton
            [ResInner,dQ12] = ResidualInner(T0,Talpha,a,b,c,rhs);    % Compute the residual of the inner iterations and the Jacobian of Q=Q1-Q2
